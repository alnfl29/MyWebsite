...
<head>
    ...
    <style>
        ...
        header h1:first-child {
            margin-bottom: 0.1em;
            font-size: 3em;
            /* Ukuran font yang sedikit lebih kecil untuk "Selamat Datang" */
            color: #FFD700;
            /* Warna emas */
            margin: 350px;
...
<body>
    ...
    <!-- Navbar -->
    <nav>
        <a href="#" data-target="home">Home/Beranda</a>
        <a href="#" data-target="about-me">About Me/Tentang Saya</a>
        <a href="#contact-form">Form Kontak</a>
        <a href="#" id="dark-mode-btn">Dark Mode</a>
        <a href="#" id="light-mode-btn">Light Mode</a>
    </nav>
